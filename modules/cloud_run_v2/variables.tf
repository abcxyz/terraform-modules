...
variable "command" {
  type        = list(string)
  default     = []
  description = "Commands for the cloud run container's entrypoint."
}

variable "args" {
  type        = list(string)
  default     = []
  description = "Arguments to the cloud run container's entrypoint which is appended to the command."
}
...
variable "vpc" {
  ...
  default     = null
  description = "Optional direct VPC configuration"
}

variable "launch_stage" {
  type        = string
  default     = "GA"
  description = "The launch stage."
}
