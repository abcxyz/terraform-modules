...
| <a name="input_dashboard_json_files"></a> [dashboard\_json\_files](#input\_dashboard\_json\_files) | Path to a dashboard configuration JSON files | `list(string)` | n/a | yes |
