...
| <a name="input_runbook_urls"></a> [runbook\_urls](#input\_runbook\_urls) | URLs of markdown files. | <pre>object({<br>    forward_progress = optional(string)<br>    container_util   = optional(string)<br>    bad_request      = optional(string)<br>    server_fault     = optional(string)<br>  })</pre> | <pre>{<br>  "bad_request": "",<br>  "container_util": "",<br>  "forward_progress": "",<br>  "server_fault": ""<br>}</pre> | no |
